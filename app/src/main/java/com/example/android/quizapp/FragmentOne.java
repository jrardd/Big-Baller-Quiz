...
public class FragmentOne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TextView correct = getActivity().findViewById(R.id.correct); //Correct notification
        final TextView wrong = getActivity().findViewById(R.id.wrong);     //Incorrect notification
        final Button choice1 = view.findViewById(R.id.c1);
        final Button choice2 = view.findViewById(R.id.c2);                 //4 Button choices
        ...
        choice1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                choice1.setBackgroundColor(Color.parseColor("#198e00"));
